...
//aki chamo o container de config
$builder = new \DI\ContainerBuilder();
$builder->addDefinitions('config.php');
$container = $builder->build();
$user = $container->get(User::class);//eu cham so classe Useer ja q o container sabe q tem q criar obj pdo automat
...
if (isset($_POST['btnLogar'])) {
  ...
  //antes criava o objeto use agora com o container n precisa
  //ja coloca la em cima td do container na variave $user
  //$user = new User();
